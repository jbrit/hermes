...
export declare namespace IEscrowFactory {
  export type DstImmutablesComplementStruct = { amount: BigNumberish };

  export type DstImmutablesComplementStructOutput = [amount: bigint] & {
    amount: bigint;
  };
}
...
export interface EscrowFactoryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      IEscrowFactory.DstImmutablesComplementStruct
    ]
  ): string;
...
export interface EscrowFactory extends BaseContract {
  ...
  createSrcEscrow: TypedContractMethod<
    [
      srcImmutables: IBaseEscrow.ImmutablesStruct,
      dstComplement: IEscrowFactory.DstImmutablesComplementStruct
    ],
    [void],
    "nonpayable"
  >;
