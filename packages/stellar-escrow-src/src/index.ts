...
export interface Client {
   ...
   */
  withdraw_to: ({secret, target, immutables}: {secret: Buffer, target: string, immutables: Immutables}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  public_cancel: ({immutables}: {immutables: Immutables}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAEAAAAAAAAAB2ZhY3RvcnkAAAAAEwAAAAA=",
        ...
        "AAAAAAAAAAAAAAALd2l0aGRyYXdfdG8AAAAAAwAAAAAAAAAGc2VjcmV0AAAAAAAOAAAAAAAAAAZ0YXJnZXQAAAAAABMAAAAAAAAACmltbXV0YWJsZXMAAAAAB9AAAAAKSW1tdXRhYmxlcwAAAAAAAA==",
        ...
        "AAAAAAAAAAAAAAANcHVibGljX2NhbmNlbAAAAAAAAAEAAAAAAAAACmltbXV0YWJsZXMAAAAAB9AAAAAKSW1tdXRhYmxlcwAAAAAAAA==",
  ...
  public readonly fromJSON = {
    withdraw: this.txFromJSON<null>,
        withdraw_to: this.txFromJSON<null>,
        public_withdraw: this.txFromJSON<null>,
        cancel: this.txFromJSON<null>,
        public_cancel: this.txFromJSON<null>
  }
}